...
<%@ include file="world_main_top.jsp" %>
           ...
           <%--        <c:if test = "${empty getUpdateNews }">
                  	<span class="updated_news_left1">최신 소식이 없습니다! </span>      
                  </c:if> --%>               
                  <c:forEach var = "dto" items ="${listUpdateNews}">             	                       
                    <span class="updated_news_left1"><span class="updated_news_red">&nbsp;사진첩&nbsp;</span>${dto.photo_title} </span>                         
                    <span class="updated_news_left2"><span class="updated_news_blue">&nbsp;게시판&nbsp;</span>${dto.board_title}</span>                 
                    </c:forEach>             
   				</div>
                  <div class="updated_news_right">
                    <div class="updated_news_right1">다이어리<span class="updated_news_right_number"><a href = "diary_main.do">0/25</a></span> &emsp;&emsp;&emsp;&emsp;사진첩 <span class="updated_news_right_number"><a href ="photo_main.do">${getListPhotoCount}/25</a></span></div>
                    <div class="updated_news_right2">게시판 <span class="updated_news_right_number"><a href = "board_main.do">${getListBoardCount}/25</a></span> &emsp;&emsp;&emsp;&emsp;&emsp;방명록 <span class="updated_news_right_number"><a href ="visit_main.do">${getListVisitCount}/25</a></span></div>
