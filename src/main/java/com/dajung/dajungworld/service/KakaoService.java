...
public class KakaoService {
	...
	public String getAccessToken (String authorize_code) {
		...
		try {
			...
			sb.append("&client_id=2826f2ac804b472722dbaaafc93c681e"); //본인이 발급받은 key
			sb.append("&redirect_uri=http://localhost:8081/dajungworld/kakaoLogin"); // 본인이 설정한 주소
